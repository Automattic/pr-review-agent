...
6. Restart Cursor (or Developer: Reload Window)
7. Go back to the MCP Servers settings, hit the refresh button and confirm you see the tools for both the Git and GitHub servers.
8. Update your Cursor rules to shortcut to the review agent:
...
2. Type `@@review` and paste a link to a Github PR that has been opened for the project you pointed the PROJECT_REPOSITORY_PATH to.
